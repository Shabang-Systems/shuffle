...
ALLOWED_HOSTS = ['shuffle.shabang.cf', 'localhost']
CSRF_TRUSTED_ORIGINS = ['shuffle.shabang.cf', 'localhost']
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'shuffle', 'static_resources'),
)
